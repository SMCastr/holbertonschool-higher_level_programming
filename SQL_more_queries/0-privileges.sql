...
-- Note: It's not granting any privileges to 'user_0d_2' intentionally for demonstration purposes
-- In a real scenario, you might grant specific privileges as needed for 'user_0d_2'
